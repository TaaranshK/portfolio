...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-black">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(55%_60%at_70%_35%,rgba(13,88,202,0.35),transparent_70%)]"></div>

      <motion.div
        className="relative z-10 px-4 sm:px-8 lg:px-10 py-16 md:py-20 
      ...
      >
        ...
        <p className="text-xs text-gray-400">
          &copy; {new Date().getFullYear()} Taaransh Kapoor. All rights reserved.
        </p>
